...
ActiveRecord::Schema.define(version: 20180222212259) do
  ...
  create_table "teams", force: :cascade do |t|
    ...
    t.index ["name", "league"], name: "index_teams_on_name_and_league", unique: true, using: :btree
  end
