class Accessory < ApplicationRecord
  ...
  def first_line_entries(image_url, accessory_size)
    ...
    csv_line << seo_description(accessory_size)
  ...
  def csv_lines_for_clearance(item, accessory_color)
    ...
    return false unless accessory_size
    lines << csv_line_for_size_and_color(item.size, accessory_color, accessory_size, image_url, true)
    lines
  end
